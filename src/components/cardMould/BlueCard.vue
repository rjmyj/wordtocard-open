            ...
            <div class="card" >
              <div class="card-ri">
                <div :class="card__content_css">
                  <a-row>
                    <a-col :span="12" style="font-weight: bold;color: #597EFF">card</a-col>
                    <a-col :span="12" style="text-align: right;color: #597EFF;font-weight: bold;">Note</a-col>
                  </a-row>
                ...
                <div style="text-align: center;margin-top: -15px;">
                  <div style="height: 2px;background-color: #597EFF;position: relative;transform: rotate(-2deg);width: 90%;margin: auto;"></div>
                </div>
              </div>
            </div>
