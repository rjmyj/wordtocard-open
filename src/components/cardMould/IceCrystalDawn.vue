...
onMounted(()=>{
  ...
  if(lineCardHeight.value === '0px'){
    ...
    lineCardHeight.value = Number(lineCardHeight.value.replace('px','')) - 70 + 'px'
...
.header-div{
  background-image: url('@/assets/iceheader.png'); /* 使用绝对路径 */
  width: 100%;
...
.foot-div{
  background-image: url('@/assets/icefoot.png'); /* 使用绝对路径 */
  width: 100%;
  background-size: cover;
...
.card__content {
  background-image: url('@/assets/icecenter.png'); /* 使用绝对路径 */
  width: 100%;
