      ...
      <div>
        ...
        <div v-for="(item,index) in htmlConList">
          <div class="container" :id="index+'img'">
            <div style="height: 50px;background-color: #e7ecff;width:80%;margin: auto;margin-bottom: -45px;border-radius: 20px"></div>
            <div style="height: 50px;background-color: #ced8ff;width:85%;margin: auto;margin-bottom: -70px;border-radius: 20px"></div>
            <div class="card">
...
onMounted(()=>{
  ...
  if(lineCardHeight.value === '0px'){
    ...
    lineCardHeight.value = Number(lineCardHeight.value.replace('px','')) - 30 + 'px'
